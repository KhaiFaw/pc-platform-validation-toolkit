...
This is the initial requirements set. Verification references will be expanded as modules are implemented.
...
| FR-005 | Persist canonical runs and produce JSON, Markdown, and self-contained HTML reports. | SQLite and canonical JSON verified in Milestone 6; Markdown/HTML pending Milestone 7 |
| FR-006 | Create immutable named baselines and compare compatible runs. | Baseline repository and comparator tests |
| NFR-001 | Support Python 3.12+ and Windows 11 x86-64 as the primary environment. | Clean setup verification |
